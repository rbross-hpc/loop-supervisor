...
Numbers `0001`–`0011` were written by hand to record the initial loop
...
agent-output parse leniency, and downstream-role objective-restatement
tolerance. From here on, ADRs are proposed by
